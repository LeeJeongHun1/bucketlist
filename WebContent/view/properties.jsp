...
<style>
.searchBorder{    width: 1098px;
    margin: 15px auto 0;
    padding: 15px 0;
    text-align: center;
    border: 1px solid #ececec;
}
.searchColor{    display: inline;
    font-size: 16px;
    
    font-weight: 600;}
.sub_title {margin-left: 15px;
    font-weight: bold;}
.c_title { font-size:15px; margin-left:17px;}
...
<body>
	...
	<div class="properties-area recent-property"
		...
		<div class="container">
			...
			<span class="searchColor">'미얀마'에 대한 <span style="color: #f8931f;">총 5 건</span>의 여행상품 검색 결과가 있습니다.</span>
			</div>
      ...
      minDate : -1
						...
						<h4 class="c_title">기간별</h4>
								<div class="col-md-12">
									...
									<div class="col-sm-12">
										<div class="checkbox">
											<label> <input type="checkbox">3일이하</label>
										</div>
									</div>
									<!-- End of  -->
									...
									<div class="col-sm-12">
										<div class="checkbox">
											<label> <input type="checkbox">4일~5일</label>
										</div>
									</div>
									<!-- End of  -->
								...
								<h4 class="c_title">기타</h4>	
										<div class="col-sm-12">
										<div class="checkbox">
											<label> <input type="checkbox">전체검색</label>
										</div>
									</div>
									<div class="col-sm-12">
										
										<button class="btn search-btn" type="submit" style="width:140px; font-weight:bold;">결과 내 재검색</button>
									</div>
								</div>
							</div>
						</form>
